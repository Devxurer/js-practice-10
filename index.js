...
function customAssign(...objects) {
  ...
  if (objects < 2) {
    ...
    let double = Object.assign(...objects);
    for (let value in double) {
      if (typeof double[value] === "number") {
...
function customObjectFromEntries(entries) {
  ...
  if (!Array.isArray(entries)) {
    ...
    let newObject = Object.fromEntries(check);
    return newObject;
  }
}
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  if (typeof obj1 !== "object" || typeof obj2 !== "object") {
    ...
    let double = Object.assign(obj1, obj2);
    let newObject = Object.freeze(double);
    if (Object.isFrozen(newObject)) {
      return newObject;
    } else {
      return "Object is not frozen";
    }
  }
}
...
function filterObjectsByKey(arr, key) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let filtredArray = arr.filter((obj) => obj.hasOwnProperty(key));
    return filtredArray;
  }
}
...
function sealAndCheck(obj) {
  ...
  if (typeof obj !== "object") {
    ...
    let packIt = Object.seal(obj);

    let check = Object.isSealed(obj);
...
function getObjectValuesSum(obj) {
  ...
  if (typeof obj !== "object") {
    ...
    let sumValues = getAllValues.reduce((accumulator, currentValue) => {
